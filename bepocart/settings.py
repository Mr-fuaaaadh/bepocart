...
ALLOWED_HOSTS = ["localhost","127.0.0.1","4a48-117-193-85-167.ngrok-free.app"]
CSRF_TRUSTED_ORIGINS = ["https://4a48-117-193-85-167.ngrok-free.app"]

APPEND_SLASH = False

CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "https://4a48-117-193-85-167.ngrok-free.app",
