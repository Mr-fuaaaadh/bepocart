...
ALLOWED_HOSTS = ["localhost","127.0.0.1","convenience-yeast-craig-ignored.trycloudflare.com"]
CSRF_TRUSTED_ORIGINS = ["https://convenience-yeast-craig-ignored.trycloudflare.com"]

APPEND_SLASH = False

CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "https://convenience-yeast-craig-ignored.trycloudflare.com",
