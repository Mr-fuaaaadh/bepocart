...
ALLOWED_HOSTS = ["localhost","127.0.0.1","knowledge-cartoon-economy-co.trycloudflare.com"]
CSRF_TRUSTED_ORIGINS = ["https://knowledge-cartoon-economy-co.trycloudflare.com"]
