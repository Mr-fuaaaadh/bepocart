...
ALLOWED_HOSTS = ["localhost","127.0.0.1","fountain-compliance-guarantee-fruits.trycloudflare.com"]
CSRF_TRUSTED_ORIGINS = ["https://fountain-compliance-guarantee-fruits.trycloudflare.com"]

APPEND_SLASH = False

CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "https://fountain-compliance-guarantee-fruits.trycloudflare.com",
