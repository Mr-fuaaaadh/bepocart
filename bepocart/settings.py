...
ALLOWED_HOSTS = ["localhost","127.0.0.1","5cd2-59-92-192-37.ngrok-free.app"]
CSRF_TRUSTED_ORIGINS = ["https://5cd2-59-92-192-37.ngrok-free.app"]

APPEND_SLASH = False

CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "https://5cd2-59-92-192-37.ngrok-free.app",
